...
By downloading, installing, or using the SkyVista mobile application ("App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use the App.
...
- Attempt to decompile, reverse engineer, or bypass any security features of the App.
- Use the App in any way that could damage, disable, or impair our services.
- Automated scraping or data mining of weather data provided within the App is strictly prohibited.

## 5. Intellectual Property

The App, including its original content (excluding weather data from third parties), features, and functionality, are and will remain the exclusive property of SkyVista and its licensors. Our trademarks and trade dress may not be used in connection with any product or service without prior written consent.
...
The App is provided on an "AS IS" and "AS AVAILABLE" basis. While we strive to provide accurate weather information, we do not guarantee the accuracy, completeness, or timeliness of the weather data provided by third-party APIs.
